...
CREATE TABLE IF NOT EXISTS community (
                                         guid              VARCHAR PRIMARY KEY,
                                         community_name    VARCHAR  NOT NULL,       -- 社区名称 --
                                         photo             VARCHAR  NOT NULL,       -- 社区头像 --
                                         introduce         VARCHAR  NOT NULL,       -- 社区简介 --
                                         created_at        TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
                                         updated_at        TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
CREATE INDEX IF NOT EXISTS idx_community_guid ON community (guid);